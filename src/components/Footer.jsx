    ...
    <div className='bg-[#E3E3E3] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
        <div>
            ...
            <div className='flex justify-between md:w-[75%] my-6'>
                <AiOutlineInstagram size={30} className='inline-block text-[#104730]'/>
                <AiOutlineFacebook size={30} className='inline-block text-[#104730]'/>
                <FaAirbnb size={30} className='inline-block text-[#104730]'/>
                <TbBrandBooking size={30} className='inline-block text-[#104730]'/>
            </div>
        </div>
    </div>
  )
